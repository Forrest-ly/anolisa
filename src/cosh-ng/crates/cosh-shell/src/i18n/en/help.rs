...
pub(super) fn message(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::HelpGroupInfo => "Info",
        MessageId::HelpSummaryStatus => "show version and provider information",
        MessageId::HelpSummaryAbout => "show version information",
        MessageId::HelpSummaryStats => "show usage statistics",
