...
OpenCode and the DeepSeek Harness hook-bridge adapter (`deepseek-harness`) currently use the
bundled lifecycle scripts documented below and are not registered with the
